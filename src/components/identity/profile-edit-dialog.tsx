...
import { AvatarCropperDialog } from "@/components/identity/avatar-cropper-dialog";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export function ProfileEditDialog({
  ...
  const member = useAppStore((s) =>
    memberId ? s.members[memberId] : undefined,
  );
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent>
          ...
          <div className="flex flex-col gap-4 py-2">
            ...
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {photoUrl ? (
                    <MemberAvatar
                      member={{ avatar_photo_url: photoUrl }}
                      className="size-14"
                    />
                  ) : (
            ...
            >
              <MemberAvatar
                member={{ avatar_photo_url: photoUrl, avatar_emoji: emoji }}
                className="size-6"
