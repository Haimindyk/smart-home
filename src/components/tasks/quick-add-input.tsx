...
export function QuickAddInput({
  ...
  return (
    <form
      className="glass mb-3 flex items-center gap-2 rounded-2xl px-3 py-2.5 ring-1 ring-border/40 transition-shadow duration-150 ease-(--ease-premium) focus-within:shadow-md focus-within:ring-ring/50"
      onSubmit={(e) => {
        e.preventDefault();
        submit();
      }}
